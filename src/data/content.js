...
export const projects = [
  {
    ...
    link: 'https://airesume.cogod.cn/',
    repo: 'https://github.com/Katrina55553/Resume-Agent/',
    icon: 'sparkles',
  ...
  },
  {
    ...
    link: 'https://oj.cogod.cn/',
    repo: 'https://github.com/Katrina55553/OJ',
    icon: 'terminal',
  ...
  {
    name: 'DuoLink 双机传输',
    description: '纯前端 P2P 传输工具，两台设备通过 WebRTC 直连实时同步文字、互发图片与文件（≤200MB），内置 Markdown 共享笔记，无需登录、无需后端。',
    tags: ['React 18', 'TypeScript', 'Vite 5', 'PeerJS', 'WebRTC'],
    link: 'https://katrina55553.github.io/DuoLink/',
    repo: 'https://github.com/Katrina55553/DuoLink',
    icon: 'link',
    highlights: ['WebRTC P2P 直连传输', '16KB 分片 + 4MB 背压控制', 'file-meta/chunk/end/cancel 传输协议', 'Markdown 共享笔记实时同步'],
  },
]
...
export const resume = {
  ...
  experience: [
    ...
    {
      role: 'DuoLink 双机传输',
      company: '前端项目 · React 18 + TypeScript + Vite 5 + PeerJS',
      period: '个人项目',
      description: '纯前端 P2P 传输工具，两台设备通过 WebRTC 直连实时同步文字、互发图片与文件（≤200MB），内置 Markdown 共享笔记，无需登录、无需后端。',
      achievements: [
        'usePeer Hook 封装 PeerJS：hello/accept/reject 握手协议 + file-meta/chunk/end/cancel 文件传输协议',
        '16KB 分片发送 + RTCDataChannel.bufferedAmount 背压控制（4MB 暂停 / 1MB 恢复），保证大文件稳定传输',
        '图片接收转 data URL 内联显示，其他文件触发下载并保留 blobUrl 供再次下载',
        '多笔记 Markdown 共享笔记：CodeMirror 6 编辑器 + GFM/KaTeX/Mermaid 渲染，连接后整份笔记状态 P2P 实时同步',
      ],
    },
  ],
  education: [
